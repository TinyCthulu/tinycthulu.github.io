...
If we are okay with this compromise, we can start asking more specific questions about [*how* to procedurally generate a mystery]({% post_url 2020-04-19-the-procedural-procedural-pt-II %}); specifically while maximizing player agency, and maintaining some narrative direction.
